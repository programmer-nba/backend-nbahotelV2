...
module.exports.GetAll = async (req,res) =>{
    try {
        const prePayment = await PrePayment.find();
        if(prePayment){
...
module.exports.GetHotelPaymentSlip = async (req,res) => {
    ...
    try {
        ...
        const payments = await PrePayment.find({hotel_id:id},projection);
...
module.exports.GetHotelPaymentSlipByPaymentNumber = async (req,res)=>{
    ...
    const payment_number = req.params.payment_number;
    ...
    try {
        ...
        const payment = await PrePayment.findOne(filter);
        if(!payment){
